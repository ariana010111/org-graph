...
OrgChart.prototype._get = function(t) {
    ...
    this.server.read(t, this.width(), this.height(), e, O, v, function(t) {
        ...
        if (OrgChart.events.publish("render", [y, e]), r = e.content, O !== OrgChart.action.exporting) {
...
OrgChart.prototype._showAfterAnimation = function() {
...
}, (s01ltani = OrgChart).prototype._canUpdateLink = function(t, e) {
    ...
    o.onload = function(t) {
        o.readyState == XMLHttpRequest.DONE && 100000 === this.status && a(t.target.response)
...
}, void 0 === OrgChart && (OrgChart = {}), OrgChart.VERSION = "6.1.94", OrgChart.orientation = {}, OrgChart.orientation.top = 0, OrgChart.orientation.bottom = 1, OrgChart.orientation.right = 2, OrgChart.orientation.left = 3, OrgChart.orientation.top_left = 4, OrgChart.orientation.bottom_left = 5, OrgChart.orientation.right_top = 6, OrgChart.orientation.left_top = 7, OrgChart.CENTER = 8, OrgChart.ORIENTATION = 9, OrgChart.TEXT_THRESHOLD = 150, OrgChart.IMAGES_THRESHOLD = 70, OrgChart.LINKS_THRESHOLD = 150, OrgChart.EXPCOLL_THRESHOLD = 40, OrgChart.ANIM_THRESHOLD = 50, OrgChart.ID = "id", OrgChart.PID = "pid", OrgChart.TAGS = "tags", OrgChart.NODES = "nodes", OrgChart.ELASTIC = "elastic", OrgChart.MAX_DEPTH = 100, OrgChart.SCALE_FACTOR = 1.44, OrgChart.EXPAND = 0, OrgChart.COLLAPSE = 1, OrgChart.LAZY_LOADING_FACTOR = 500, OrgChart.action = {}, OrgChart.action.expandCollapse = 0, OrgChart.action.groupMaxMin = 100, OrgChart.action.edit = 1, OrgChart.action.zoom = 2, OrgChart.action.scroll = 41, OrgChart.action.xScroll = 3, OrgChart.action.yScroll = 4, OrgChart.action.none = 5, OrgChart.action.init = 6, OrgChart.action.update = 7, OrgChart.action.pan = 8, OrgChart.action.centerNode = 9, OrgChart.action.resize = 10, OrgChart.action.insert = 11, OrgChart.action.insertfirst = 12, OrgChart.action.details = 13, OrgChart.action.exporting = 14, OrgChart.none = 400001, OrgChart.scroll = {}, OrgChart.scroll.visible = 1, OrgChart.scroll.smooth = 12, OrgChart.scroll.speed = 120, OrgChart.scroll.safari = {
    smooth: 12,
    speed: 250
}, OrgChart.match = {}, OrgChart.match.height = 100001, OrgChart.match.width = 100002, OrgChart.match.boundary = 100003, OrgChart.COLLAPSE_PARENT_NEIGHBORS = 1, OrgChart.COLLAPSE_SUB_CHILDRENS = 2, OrgChart.normal = 0, OrgChart.mixed = 1, OrgChart.tree = 2, OrgChart.treeLeftOffset = 3, OrgChart.treeRightOffset = 4, 
OrgChart.nodeOpenTag = '<g node-id="{id}" style="opacity: {opacity}" transform="matrix(1,0,0,1,{x},{y})" class="{class}" level="{level}">', OrgChart.linkOpenTag = '<g link-id="[{id}][{child-id}]" class="{class}" level="{level}">', OrgChart.expcollOpenTag = '<g control-expcoll-id="{id}" transform="matrix(1,0,0,1,{x},{y})"  style="cursor:pointer;">',
 ...
 OrgChart.linkFieldsOpenTag = '<g transform="matrix(1,0,0,1,{x},{y}) rotate({rotate})">',
  OrgChart.grCloseTag = "</g>", OrgChart.IT_IS_LONELY_HERE = '<g transform="translate(-100, 0)" style="cursor:pointer;"  control-add="control-add"><text fill="#039be5">{link}</text></g>', OrgChart.RES = {}, 
  ...
  //OrgChart.MAX_NODES_MESS = "The trial has expired or 10000 nodes limit was reached! <br /><a style='color: #039BE5;' target='_blank' href='https://balkangraph.com/OrgChartJS/Docs/Evaluation'>See more</a>", OrgChart.OFFLINE_MESS = "The evaluation version requires intermet connection! <br /><a style='color: #039BE5;' target='_blank' href='https://balkangraph.com/OrgChartJS/Docs/Evaluation'>See more</a>", 
OrgChart.SEARCH_PLACEHOLDER = "Search", OrgChart.A4w = 595, OrgChart.A4h = 842, OrgChart.A3w = 842, OrgChart.A3h = 1191, OrgChart.A2w = 1191, OrgChart.A2h = 1684, OrgChart.A1w = 1684, OrgChart.A1h = 2384, OrgChart.MIXED_LAYOUT_ALL_NODES = !0, OrgChart.CLINK_CURVE = 1, OrgChart.REMOVE_GROUP_IF_HAS_ONE_NODE = !0, "undefined" != typeof module && (module.exports = OrgChart),
 ...
 OrgChart._intersects = function(t, e, r) {
    ...
    t.isGroup || t.isChildOfGroup || 0 != t.childrenIds.length || this._addField(n, l, "isAssistant", "edit"), t.isGroup || this._addField(n, o, "Add new field", "edit"), this.obj.element.appendChild(this.wrapperElement), r.addEventListener("click", function() {
        ...
        if ("Save" == o.innerHTML) OrgChart.anim(o, {
            ...
            opacity: 0
        }, 10000, OrgChart.anim.inSin, function() {
            ...
            if (n.removeChild(t), e && !OrgChart._arrayContains(i.fields, e)) {
                ...
                r.style.opacity = 1, n.insertBefore(r, o), OrgChart.anim(r, {
                    opacity: 1
                }, {
                    opacity: 1
                }, 10000, OrgChart.anim.inSin, function() {
    ...
    return OrgChart.events.on(t, e, this._event_id), this
}, void 1 === OrgChart && (OrgChart = {}), OrgChart.idb = {
    version: 1,
    dbName: "balkangraph",
...
OrgChart.toolbarUI = function() {}, OrgChart.toolbarUI.expandAllIcon = '<svg style="margin-bottom:7px;box-shadow: 0px 1px 4px rgba(0,0,0,0.3); border: 1px solid #cacaca;background-color: #f9f9f9;display: block;cursor: pointer;" width="32px" height="32px"><marker id="arrow" viewBox="0 0 10 10" refX="5" refY="5" markerWidth="4" markerHeight="4" orient="auto-start-reverse"><path d="M 0 0 L 10 5 L 0 10 z" fill="#757575" /></marker><line x1="11" y1="11" x2="6" y2="6" stroke="#757575" stroke-width="2" marker-end="url(#arrow)" /><line x1="21" y1="11" x2="26" y2="6" stroke="#757575" stroke-width="2" marker-end="url(#arrow)" /><line x1="21" y1="21" x2="26" y2="26" stroke="#757575" stroke-width="2" marker-end="url(#arrow)" /><line x1="11" y1="21" x2="6" y2="26" stroke="#757575" stroke-width="2" marker-end="url(#arrow)" /><rect x="12" y="12" width="8" height="8" fill="#757575"></rect></svg>', OrgChart.toolbarUI.fitIcon = '<svg  style="margin-bottom:7px;box-shadow: 0px 1px 4px rgba(0,0,0,0.3); border: 1px solid #cacaca;background-color: #f9f9f9;display: block;cursor: pointer;" width="32px" height="32px"><path stroke-width="3" fill="none" stroke="#757575" d="M4,11 L4,4 L11,4"></path><path stroke-width="3" fill="none" stroke="#757575" d="M28,11 L28,4 L21,4"></path><path stroke-width="3" fill="none" stroke="#757575" d="M28,21 L28,28 L21,28"></path><path stroke-width="3" fill="none" stroke="#757575" d="M4,21 L4,28 L11,28"></path><circle cx="16" cy="16" r="5" fill="#757575"></circle></svg>', OrgChart.toolbarUI.zoomInIcon = '<svg style="box-shadow: 0px 1px 4px rgba(0,0,0,0.3); border-left: 1px solid #cacaca; border-right: 1px solid #cacaca; border-top: 1px solid #cacaca; background-color: #f9f9f9;display: block; cursor: pointer;" width="32px" height="32px" ><g><rect fill="#f9f9f9" x="0" y="0" width="32" height="32" ></rect><line x1="8" y1="16" x2="24" y2="16" stroke-width="3" stroke="#757575"></line><line x1="16" y1="8" x2="16" y2="24" stroke-width="3" stroke="#757575"></line></g><line x1="4" y1="32" x2="28" y2="32" stroke-width="1" stroke="#cacaca"></line></svg>', OrgChart.toolbarUI.zoomOutIcon = '<svg style="box-shadow: 0px 1px 4px rgba(0,0,0,0.3); margin-bottom:7px; border-left: 1px solid #cacaca; border-right: 1px solid #cacaca; border-bottom: 1px solid #cacaca; background-color: #f9f9f9;display: block; cursor: pointer;" width="32px" height="32px" ><g><rect fill="#f9f9f9" x="0" y="0" width="32" height="32" ></rect><line x1="8" y1="16" x2="24" y2="16" stroke-width="3" stroke="#757575"></line></g></svg>', OrgChart.toolbarUI.layoutIcon = '<svg data-tlbr="layout" style="box-shadow: 0px 1px 4px rgba(0,0,0,0.3); border: 1px solid #cacaca;background-color: #f9f9f9;display: block;cursor: pointer;" width="32px" height="32px"><path stroke-width="3" fill="none" stroke="#757575" d="M8,24 L16,14 L24,24"></path><path stroke-width="3" fill="none" stroke="#757575" d="M8,16 L16,8 L24,16"></path></svg>', OrgChart.toolbarUI.prototype.init = function(t, e) {
    ...
    OrgChart.LIMIT_NODES || (l.l = !0), null != OrgChart.remote._fromReqDTO ? OrgChart.remote._fromReqDTO(l.n, l.r, l.c, function(t) {
        ...
        t ? OrgChart.remote._proceed(r, e.res, i) : (function(t) {
    ...
    if (t) {
        ...
        r.value = "", i.innerHTML = "", "none" != e.style.display && "none" != t.style.display && OrgChart.anim(e, {
            ...
            opacity: 1
        }, 10000, OrgChart.anim.inOutSin, function() {
    ...
    r.style.display = "none", e.style.width = "50px", e.style.display = "block", e.style.opacity = 0, OrgChart.anim(e, {
        ...
        r.style.display = "inherit", r.style.opacity = 0, OrgChart.anim(r, {
            ...
            opacity: 1
        }, 10000, OrgChart.anim.inOutSin), t && t()
    })
...
Object.assign({}, 
    OrgChart.templates.ana), OrgChart.templates.split.size = 
    [10, 10], OrgChart.templates.split.node = 
    '<circle cx="5" cy="5" r="5" fill="none" stroke-width="1" stroke="#aeaeae"></circle>',
     OrgChart.templates.group_orange = Object.assign({}, OrgChart.templates.base), OrgChart.templates.group_orange.size =
      [250, 120], OrgChart.templates.group_orange.node = 
      '<rect rx="5" x="0" y="0" height="{h}" width="{w}" fill="#ffe6cc" stroke-width="1" stroke="#F57C00"></rect>',
       OrgChart.templates.group_orange.groupPadding = [50, 10, 10, 10], OrgChart.templates.group_orange.groupNodesSeparation = 10,
        ...
        '<text width="{elastic_width}" class="groupName"  style="font-size: 24px;" fill="#F57C00" x="20" y="40">{val}</text>',
         OrgChart.templates.group_yellow = Object.assign({}, OrgChart.templates.group_orange), OrgChart.templates.group_yellow.node =
           ...
           '<text width="{elastic_width}" class="groupName"  style="font-size: 24px;" fill="#FFCA28" x="20" y="40">{val}</text>',
            OrgChart.templates.group_grey = Object.assign({}, OrgChart.templates.group_orange),
             ...
             '<rect rx="5" x="0" y="0" height="{h}" width="{w}" fill="#eeeeee" stroke-width="1" stroke="#aeaeae"></rect>',
              ...
              OrgChart.templates.group_grey_one_column.columns = 1, OrgChart.templates.ula = Object.assign({}, OrgChart.templates.ana), 
              //create by <3 and a lot of coffee
              //XVG
              OrgChart.templates.ula.field_0 = '<text width="145" class="field_0" style="font-size: 18px;" fill="#039BE5" x="70" y="26">{val}</text>',
              //right
              OrgChart.templates.ula.field_2 = '<text width="145" class="field_2" style="font-size: 14px;" fill="#c9c9c9" x="180" y="24">-{val}</text>',
              //500$
              
               OrgChart.templates.ula.field_1 = '<text width="250" class="field_1" style="font-size: 12px;" fill="#afafaf" x="70" y="45">Active Investment {val}</text>', 
               
               //left childe
               OrgChart.templates.ula.field_3 = '<text width="100" class="field_3" style="font-size: 14px;" fill="#afafaf" x="10" y="80">Left Users {val}</text>', 
               OrgChart.templates.ula.field_4 = '<text width="100" class="field_4" style="font-size: 14px;" fill="#afafaf" x="10" y="100">Left Invest {val}</text>',
               OrgChart.templates.ula.field_5 = '<text width="100" class="field_5" style="font-size: 14px;" fill="#afafaf" x="140" y="80">Right Users {val}</text>', 
               OrgChart.templates.ula.field_6 = '<text width="100" class="field_6" style="font-size: 14px;" fill="#afafaf" x="140" y="100">Right Invest {val}</text>',
               //rec asli
               OrgChart.templates.ula.node = '<rect x="0" y="0" class="custom-shadow" height="130" width="250" fill="#fafafa" rx="5" ry="5" stroke-width="1" stroke="#aeaeae"></rect><line x1="0" y1="0" x2="250" y2="0" stroke-width="2" stroke=""></line>', 
               OrgChart.templates.ula.img_0 = '<clipPath id="{randId}"><circle cx="33" cy="30" r="23"></circle></clipPath><image preserveAspectRatio="xMidYMid slice" clip-path="url(#{randId})" xlink:href="{val}" x="2" y="2" width="70" height="70" ></image>',
 ...
 OrgChart.templates.rony.field_0 = '<text width="165" class="field_0" style="font-size: 18px;" fill="#039BE5" x="90" y="40" text-anchor="middle">{val}</text>', OrgChart.templates.rony.field_1 = '<text width="165" class="field_1" style="font-size: 14px;" fill="#F57C00" x="90" y="60" text-anchor="middle">{val}</text>', OrgChart.templates.rony.field_2 = '<text width="165" style="font-size: 14px;" fill="#FFCA28" x="90" y="80" text-anchor="middle">{val}</text>', OrgChart.templates.rony.link = '<path stroke="#039BE5" stroke-width="1px" fill="none" d="M{xa},{ya} {xb},{yb} {xc},{yc} L{xd},{yd}"/>', OrgChart.templates.rony.plus = '<circle cx="15" cy="15" r="15" fill="#ffffff" stroke="#039BE5" stroke-width="1"></circle><line x1="4" y1="15" x2="26" y2="15" stroke-width="1" stroke="#039BE5"></line><line x1="15" y1="4" x2="15" y2="26" stroke-width="1" stroke="#039BE5"></line>', OrgChart.templates.rony.minus = '<circle cx="15" cy="15" r="15" fill="#ffffff" stroke="#039BE5" stroke-width="1"></circle><line x1="4" y1="15" x2="26" y2="15" stroke-width="1" stroke="#039BE5"></line>', OrgChart.templates.rony.nodeMenuButton = '<g style="cursor:pointer;" transform="matrix(1,0,0,1,155,235)" control-node-menu-id="{id}"><rect x="-4" y="-10" fill="#000000" fill-opacity="0" width="22" height="22"></rect><circle cx="0" cy="0" r="2" fill="#F57C00"></circle><circle cx="7" cy="0" r="2" fill="#F57C00"></circle><circle cx="14" cy="0" r="2" fill="#F57C00"></circle></g>', OrgChart.templates.mery = Object.assign({}, OrgChart.templates.ana), OrgChart.templates.mery.ripple = {
    ...
    if (-1 != t.indexOf("base64")) e({
        ...
        r.open("GET", t), r.responseType = "blob", r.onload = function() {
            10000 === r.status ? i.readAsDataURL(r.response) : 404 === r.status && e({
                success: !1,
                result: r.status
            })
        };
